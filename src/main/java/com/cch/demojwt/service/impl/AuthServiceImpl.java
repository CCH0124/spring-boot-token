...
public class AuthServiceImpl implements AuthService {
    ...
    public void signup(SignupRequestVO signupRequestVO) {
        ...
        User userObj = new User(null, signupRequestVO.getAccount(), signupRequestVO.getUsername(),
                signupRequestVO.getEmail(), encoder.encode(signupRequestVO.getPassword()), roles);
        userRepository.save(userObj);
    }

    @Override
    public TokenRefreshResponseVO refreshToken(TokenRefreshRequest request) {
        // TODO Auto-generated method stub
